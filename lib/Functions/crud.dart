...
class Box {
  ...
  static Box fromJson(Map<String, dynamic> Json) => Box(vis: Json['vis']);
}
...
Future Deletequestioncollection({required String docid}) async {
  final qp = FirebaseFirestore.instance.collection("subject").doc(docid);
...
Future Deletead({required String docid}) async {
  final qp = FirebaseFirestore.instance.collection("ads").doc(docid);
...
Stream<List<Subject>> readSub() => FirebaseFirestore.instance
    .collection('subject')
...
Stream<List<Question>> readQus(String docid) => FirebaseFirestore.instance
    .collection('subject')
    .doc(docid)
    .collection('questions')
    .orderBy("id", descending: true)
...
//readad
Stream<List<Ads>> readad() => FirebaseFirestore.instance
    .collection('ads')
    .orderBy("id", descending: true)
    .snapshots()
    .map((snaphot) =>
...
Stream<List<Question>> readboxQus() => FirebaseFirestore.instance
    .collection('box')
    .doc('boxdoc')
    .collection('questions')
    .orderBy("id", descending: true)
...
readaddis() async {
  ...
  await FirebaseFirestore.instance
      ...
      .then((value) => value.docs.forEach((element) {
            l.add(Ads.fromJson(element.data()));
          }));
  return l;
}
